...
def main_menu():
    while True:
        ...
        BFS_BUTTON = Button(image=pygame.image.load("assets/Play Rect.png"), pos=(640, 250),
                             text_input="BFS", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        A_BUTTON = Button(image=pygame.image.load("assets/Options Rect.png"), pos=(640, 400),
                                text_input="A Star", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        QUI_BUTTON = Button(image=pygame.image.load("assets/Quit Rect.png"), pos=(640, 550),
        ...
        for button in [BFS_BUTTON, A_BUTTON, QUIT_BUTTON, QUI_BUTTON]:
...
window = Tk()
submit = Button(window, text='Pathfinding Using BFS Visualization', command=onsubmit)
submit.grid(columnspan=2, row=3)

submit = Button(window, text='Pathfinding Using A star Visualization', command=onsubmit2)
submit.grid(columnspan=1, row=1)
...
class InsertSortScene(Scene):
    def __init__(self, font):
        ...
        controls = [LatexLabel("$\mathcal{O}(n^2)$", (60, 40), font),
                    ...
                    SortControl(InsertSortScene.meta_insert_sort([3, 10, 2, 9, 1, 0, 2, 4, 8, 9, 10, 2, 4, 6]),
                                (100, 100))]
...
class Button:
    ...
    def redraw(self, bg):
        ...
        pygame.draw.line(self.surface, rgb_hlight(bg, -hlight), (lwidth, self.size[1] - lwidth),
                         (self.size[0], self.size[1] - lwidth), lwidth)
        pygame.draw.line(self.surface, rgb_hlight(bg, -hlight), (self.size[0] - lwidth, lwidth),
                         (self.size[0] - lwidth, self.size[1]), lwidth)
...
class MediaControlPanel:
    def __init__(self, pos, fg="white", bg="black", hoverbg="gray"):
        ...
        self.buttons = [fastBackward, stepBackButton, backButton, stopButton, playButton, stepForwardButton,
                        fastForward]
    ...
    def stepBackButtonClick(self):
        pass

    def stepForwardButtonClick(self):
        pass
